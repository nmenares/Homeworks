...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(term) {
  return function (dispatch) {
    APIUtil.fetchSearchGiphys(term).then(function (giphys) {
...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    'ul',
    null,
    giphys.map(function (el, idx) {
      return _react2.default.createElement(
        'li',
        { key: idx },
        _react2.default.createElement(_giphys_index_item2.default, { giphy: el })
      );
    })
  );
};
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('input', { onChange: this.handleChange, value: this.state.searchTerm, placeholder: 'search...' }),
          _react2.default.createElement(
            'button',
...
var gyphisReducer = function gyphisReducer() {
