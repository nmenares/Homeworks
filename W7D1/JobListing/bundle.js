...
var Widget = function (_React$Component) {
  ...
  _createClass(Widget, [{
    ...
    value: function render() {
      ...
      var jobListings = this.props.jobs.map(function (job) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    handleSelectionLocation: function handleSelectionLocation(city, jobs) {
      return dispatch((0, _actions2.default)(city, jobs));
    }
  };
};
...
var cityReducer = function cityReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.city;
...
var jobsReducer = function jobsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState.jobs;
  var action = arguments[1];
